...
/**
 * コラム・ツールページ用のシェアボタン（X / LINE / リンクコピー）。
 * サーバーコンポーネントから url と title を渡して使う。
 */
export default function ShareButtons({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-4 mb-6">
      <p className="text-center text-gray-500 text-sm mb-3 font-semibold">
        この記事をシェア
      </p>
      <div className="flex gap-2">
        ...
        <button
          onClick={copyLink}
          className="flex-1 flex items-center justify-center gap-1.5 py-3 px-3 rounded-xl bg-gray-100 text-gray-600 font-bold text-sm hover:bg-gray-200 transition-colors"
        >
          {copied ? (
            ...
            <>
              <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path strokeLinecap="round" strokeLinejoin="round" d="M13.828 10.172a4 4 0 010 5.656l-3 3a4 4 0 01-5.656-5.656l1.5-1.5m6.656-1.828a4 4 0 000-5.656l-3-3a4 4 0 00-5.656 5.656" />
              </svg>
              <span>リンク</span>
            </>
          )}
