        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
          ...
          <div className="space-y-6 text-sm text-gray-700 leading-relaxed">
            ...
            <section>
              ...
              <p className="mt-2">
                サクトレでは、いくつかの質問に答えるだけであなたに合ったトレーニングメニューを自動で作成できます。何をすればいいか迷ったら、ぜひ活用してみてください。
              </p>
            </section>
          </div>
        </div>

        <ShareButtons url="https://sakutore.vercel.app/column/beginner-guide" title="筋トレ初心者が最初にやるべき5つのこと" />
        <Link
          href="/gear"
