        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
          ...
          <div className="space-y-6 text-sm text-gray-700 leading-relaxed">
            ...
            <section>
              ...
              <p className="mt-3">
                では静的ストレッチは無駄なのかというと、そうではありません。<strong className="text-gray-800">柔軟性そのものを伸ばす効果は確かにあります</strong>。ただしそれは「筋肉痛予防」ではなく「可動域を広げてフォームを作りやすくする」という別の効果です。狙いを取り違えなければ十分に価値があります。すでに出てしまった筋肉痛への対処は
                <Link href="/column/muscle-soreness" className="text-orange-600 font-bold underline">
                  筋肉痛でも筋トレしていい？
                </Link>
                に、効くこと・効かないことを分けて書きました。
              </p>
              <p className="mt-2">
