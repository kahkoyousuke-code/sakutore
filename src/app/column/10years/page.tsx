  ...
  return (
    <main className="min-h-screen flex flex-col items-center px-4 py-8">
      <div className="max-w-md w-full animate-slideUp">
          ...
          <div className="space-y-6 text-sm text-gray-700 leading-relaxed">
            <section>
              <p className="text-gray-500 italic border-l-2 border-orange-300 pl-3 mb-3">
                私自身、20代で体重90kgを超えた状態から筋トレを始め、10年以上続けてきました。続けてわかったことを、体・メンタル・人生の変化という3つの視点でお伝えします。
              </p>
              <p>
        ...
        <ShareButtons url="https://sakutore.vercel.app/column/10years" title="10年筋トレを続けてわかったこと" />
        <Link
          href="/gear"
