        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
          ...
          <div className="space-y-6 text-sm text-gray-700 leading-relaxed">
            ...
            <section>
              ...
              <p className="mt-3">
                一番わかりやすいのは<strong className="text-gray-800">2番目の「前回と同じ重量」</strong>です。同じ種目・同じ重量で回数が落ちたら、それは気のせいではなく回復が間に合っていない客観的なサインです。逆にここが維持できているなら、多少だるくても進めて問題ありません。筋肉痛が出ている日にやっていいかどうかは
